  ...
  return (
    <div className="bg-slate-200">
      ...
      <div className="top-photo w-full bg-[url('images/bg.jpg')] bg-no-repeat bg-cover bg-center">
        <div className="text-center p-80 text-white text-6xl font-semibold">
      ...
      <div>
        <h1 className="text-center text-2xl font-bold mt-10">
          We offer a range of services through the complete electro-mechanical
        ...
        <div className="flex flex-row justify-around m-16">
          ...
          <TransparentCard
            className="basis-1/4"
            title={
              "Replace and responsibly dispose of existing electro-mechanical asset."
            }
            image={replace}
          />
        </div>
